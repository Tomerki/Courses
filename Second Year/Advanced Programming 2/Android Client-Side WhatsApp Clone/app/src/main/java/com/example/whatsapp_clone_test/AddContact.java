...
import com.example.whatsapp_clone_test.ModalsActivities.AddContactError;
...
public class AddContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddContact.setOnClickListener( v -> {
            ...
            Contact current = contactViewModel.getContact(userName.getText().toString());
            if ( current == null ) {
                ...
                Intent i = new Intent(this, AddContactError.class);
                startActivity(i);
            }
